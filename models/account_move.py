...
class AccountMove(models.Model):
    ...
    def _ubl_ext_header(self, parent_node, ns, version="2.1"):
        ...
        ext_test_n_node.text = "Invoice Number :" + str(self.name) + " ;" + "Invoice Issue Date :" + str(self.invoice_date)
    ...
    def billing_refence(self,parent_node, ns, version="2.1"):
        ...
        ctx["no_embedded_ubl_xml"] = True
        ctx["force_report_rendering"] = True
        binary_node.text = "Invoice Number :"+str(self.name)+" ;"+"Invoice Issue Date :"+str(self.invoice_date)
